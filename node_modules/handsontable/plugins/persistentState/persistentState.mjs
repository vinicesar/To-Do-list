...
export class PersistentState extends BasePlugin {
  ...
  enablePlugin() {
    ...
    if (!deprecationWarningInstances.has(this.hot)) {
      ...
      deprecatedWarn('The PersistentState plugin is deprecated and will be removed in version 17.0. ' + 'Please update your settings to ensure compatibility with future versions.');
    }
    if (!this.storage) {
