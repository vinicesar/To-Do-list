...
.ht-theme-main-dark {
  ...
  --ht-cell-autofill-fill-border-color: #f7f7f9;
  ...
  --ht-header-foreground-color: #f7f7f9;
  ...
  --ht-header-row-foreground-color: #f7f7f9;
  ...
  --ht-secondary-button-foreground-color: #f7f7f9;
  ...
  --ht-input-focus-foreground-color: #f7f7f9;
  ...
  --ht-pagination-bar-foreground-color: #f7f7f9;
